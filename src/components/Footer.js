...
const Footer = () => {
  return (
    <footer className="bg-veryDarkBlue">
      {/* Flex Container */}
      <div className="container flex flex-col-reverse justify-between px-6 py-10 mx-auto space-8 md:flex-row md:space-y-0">
        ...
        <div className="flex flex-col justify-between">
          ...
          <div className="hidden text-white md:block">
            Copyright &copy; 2022, All Rights Reseved
          </div>
        </div>
      </div>
    </footer>
